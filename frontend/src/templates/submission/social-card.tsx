...
import { SocialCardSubmissionQuery } from "../../generated/graphql";
...
type Props = {
  data: SocialCardSubmissionQuery;
  pageContext: {
    cardType: CardType;
  };
};
  ...
  <Fragment>
    ...
    >
      <Box sx={{ position: "relative" }}>
        ...
        >
          <FormattedMessage id="submission.socialCard.prefix" />
        </Text>
        ...
        >
          <FormattedMessage id="submission.socialCard.suffix" />
        </Text>
      </Box>
...
export const query = graphql`
  query SocialCardSubmission($id: ID!) {
    backend {
      submission(id: $id) {
        title
      }
