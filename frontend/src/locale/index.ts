export const messages = {
  ...
  description: "Join PyCon Italia May 27th to May 30th 2026 in Bologna, Italy!",
...
Let's get in touch to find the best solution for your business' needs!`,
  ...
  "profile.myGrant.status.waiting_list_maybe.nextSteps":
    "You are on the waiting list. We will notify you as soon as we can accept your grant.",
  "profile.myGrant.status.waiting_for_confirmation": "Waiting for Confirmation",
...
Failing to notify us may impact your eligibility for financial aid at future events.`,
  ...
  "cfp.introductionDeadline": "You have until {deadline} to submit a proposal!",
...
Click the box to change. If left empty, we will assume you are available.`,
  ...
  "grants.form.needToBeLoggedIn": "Login or create an account to send a grant",
...
We look forward to reading about you and hope to see you at PyCon Italia!
  ...
  "grants.form.fields.ageGroup.values.range_more_than_65": "65 years or older",
...
Note:  If you have submitted a talk/workshop proposal, you don't need to apply for a speaker grant to get your conference ticket refunded. We will contact you about refunding your ticket if your proposal is accepted.`,
  ...
  "grants.form.fields.grantType.values.unemployed": "Social & economic factors",
  ...
  "grants.form.fields.departureCity": "What city will you be travelling from?",
  ...
  "grants.form.fields.why": "Why are you asking for a grant for PyCon Italia?",
