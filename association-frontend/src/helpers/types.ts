...
export type LoginResult = LoginSuccess | WrongEmailOrPassword | LoginValidationError;
...
export type RegisterResult = RegisterSuccess | EmailAlreadyUsed | RegisterValidationError;
