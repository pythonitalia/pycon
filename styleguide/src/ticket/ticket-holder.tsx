...
export const TicketHolder = React.forwardRef<HTMLDivElement, Props>(
  ({ children }, ref) => (
    ...
    >
      {/* large */}
      <div className="absolute w-16 h-5 rounded-xl top-4 left-11 ticket:left-1/4 bg-orange"></div>

      {/* round one */}
      <div className="absolute w-5 h-5 transform -translate-x-1/2 rounded-full top-4 bg-orange left-1/2"></div>

      {/* large */}
      <div className="absolute w-16 h-5 rounded-xl top-4 right-11 ticket:right-1/4 bg-orange"></div>
