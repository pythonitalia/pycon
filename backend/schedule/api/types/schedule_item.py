...
from schedule.api.types.room import Room
from schedule.api.types.schedule_item_user import ScheduleItemUser
from submissions.api.types import Submission
from schedule import models

if TYPE_CHECKING:  # pragma: no cover
    from conferences.api.types import AudienceLevel, Conference, Keynote
...
class ScheduleItem:
    ...
    def keynote(
        self, info: Info
    ) -> Annotated["Keynote", strawberry.lazy("conferences.api.types")] | None:
