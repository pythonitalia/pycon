...
def test_update_invitation_answer(
    ...
    mock_event = mocker.patch(
        "schedule.api.mutations.update_schedule_invitation.notify_new_schedule_invitation_answer_slack"
    )
    mock_plain = mocker.patch(
        "schedule.api.mutations.update_schedule_invitation.send_schedule_invitation_plain_message"
    )
    mock_send_voucher = mocker.patch(
        "schedule.api.mutations.update_schedule_invitation.create_and_send_voucher_to_speaker"
    )
