        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("submission", "Submission"), ("custom", "Custom")],
                        max_length=10,
                        verbose_name="type",
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        to=settings.AUTH_USER_MODEL, verbose_name="additional speakers"
                    ),
                ),
                (
                    "conference",
                ...
                (
                    "rooms",
                    models.ManyToManyField(
                        related_name="talks", to="schedule.Room", verbose_name="rooms"
                    ),
                ),
            ],
            options={
