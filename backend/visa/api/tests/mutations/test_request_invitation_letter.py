...
from visa.api.mutations.request_invitation_letter import MAX_LENGTH_FIELDS
...
def test_request_invitation_letter(
    ...
    mock_notify = mocker.patch(
        "visa.api.mutations.request_invitation_letter.notify_new_invitation_letter_request_on_slack"
    )
