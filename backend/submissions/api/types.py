...
from voting.api.types import VoteType
...
if TYPE_CHECKING:
    from conferences.api.types import AudienceLevel, Conference, Duration, Topic
    from participants.api.types import Participant
    from schedule.api.types import ScheduleItem
    from submissions.api.mutations import SendSubmissionErrors
...
class SubmissionSpeaker:
    ...
    def participant(
        self,
    ) -> Annotated["Participant", strawberry.lazy("participants.api.types")] | None:
        return next(
            (
                participant
...
class Submission:
    conference: Annotated["Conference", strawberry.lazy("conferences.api.types")]
    title: str
    ...
    topic: Annotated["Topic", strawberry.lazy("conferences.api.types")] | None
    type: SubmissionType | None
    duration: Annotated["Duration", strawberry.lazy("conferences.api.types")] | None
    audience_level: (
        Annotated["AudienceLevel", strawberry.lazy("conferences.api.types")] | None
    )
    notes: str | None = private_field("notes")
    do_not_record: bool | None = private_field("do_not_record")

    schedule_items: list[
        Annotated["ScheduleItem", strawberry.lazy("schedule.api.types")]
    ]
