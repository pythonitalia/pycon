...
PRETIX_API_HOST = env("PRETIX_API_HOST", default="")
PRETIX_API_TOKEN = None
PRETIX_API_TIMEOUT = env.int("PRETIX_API_TIMEOUT", default=10)

DASHBOARD_REQUIRE_STAFF = env.bool("DASHBOARD_REQUIRE_STAFF", default=not DEBUG)
DASHBOARD_MAX_COMPARISON_CONFERENCES = env.int(
    "DASHBOARD_MAX_COMPARISON_CONFERENCES",
    default=2,
)
DASHBOARD_PRETIX_CACHE_TIMEOUT = env.int(
    "DASHBOARD_PRETIX_CACHE_TIMEOUT",
    default=60 * 15,
)
DASHBOARD_PRETIX_ERROR_CACHE_TIMEOUT = env.int(
    "DASHBOARD_PRETIX_ERROR_CACHE_TIMEOUT",
    default=60,
)
