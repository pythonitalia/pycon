...
USE_AWS_S3 = env("USE_AWS_S3", default=False) == "True"
if USE_AWS_S3:
    # aws settings
    ...
    STATICFILES_STORAGE = "pycon.storage_backends.StaticStorage"

    # s3 public media settings
    PUBLIC_MEDIA_LOCATION = "media"
    MEDIA_URL = f"https://{AWS_S3_CUSTOM_DOMAIN}/{PUBLIC_MEDIA_LOCATION}/"
    DEFAULT_FILE_STORAGE = "pycon.storage_backends.PublicMediaStorage"
