...
def test_submit_vote(graphql_client, user, conference_factory, submission_factory):
    ...
    resp, variables = _submit_vote(graphql_client, submission, user, value=10)
...
def test_user_can_votes_differents_submissons(
    graphql_client, user, conference_factory, submission_factory
):
    graphql_client.force_login(user)
    ...
    resp1, variables1 = _submit_vote(graphql_client, submission1, user)
    ...
    resp2, variables2 = _submit_vote(graphql_client, submission2, user)
