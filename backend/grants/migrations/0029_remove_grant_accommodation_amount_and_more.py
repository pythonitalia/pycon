# Generated by Django 5.1.4 on 2025-07-27 13:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=0,
                        help_text="Actual amount granted for this category",
                        max_digits=6,
                        verbose_name="granted amount",
                    ),
                ),
                (
                    "grant",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="grants.grantreimbursementcategory",
                        verbose_name="reimbursement category",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="grants",
                through="grants.GrantReimbursement",
                to="grants.grantreimbursementcategory",
            ),
        ),
