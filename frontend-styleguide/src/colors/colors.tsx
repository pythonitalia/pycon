...
export const Colors = () => {
  return (
    <div className="grid grid-cols-4 gap-3 p-4">
      <div>
        <div className={"w-40 h-40 border-2 border-black bg-milk"} />
        <span>milk</span>
      </div>
      <div>
      ...
      <div>
        <div className={"w-40 h-40 border-2 border-black bg-coral"} />
        <span>coral</span>
      </div>
      <div>
        <div className={"w-40 h-40 border-2 border-black bg-caramel"} />
        <span>caramel</span>
      </div>
      <div>
      ...
      <div>
        <div className={"w-40 h-40 border-2 border-black bg-grey-250"} />
        <span>grey-300</span>
      </div>
      <div>
