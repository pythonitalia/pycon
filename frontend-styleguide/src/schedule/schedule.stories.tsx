...

        {
          ...
          performers: [
            ...
            },
            {
              ...
              bio: "@PyLadiesChicago, @ThePSF Chair, Director, Fellow; @github engineer #LatinxInTech who 💖 live long, 🏳️‍🌈, 🐍, 🚀, 🏃 & prosper 🖖🏽; opinions my own. She/her.",
            },
          ],
          slug: "psf-ama",
          status: "CONFIRMED",
      ...
      events: [
...

        {
          ...
          performer: {
            ...
            bio: "Moisés Horta Valenzuela sound artist and electronic musician from Tijuana, México working in the fields of computer music and the history and politics of emerging technologies. My practice attempts to disrupt dichotomies with juxtapositions, such as utopia with dystopia and folk traditions with capitalist modernity.",
            twitter: "hexorcismos",
          ...
          performers: [
            {
              ...
              bio: "Pablo Galindo Salgado works in the Python Infrastructure team at the Software Infrastructure department at Bloomberg L.P. He is a CPython core developer and a Theoretical Physicist specialized in general relativity and black hole physics. He is currently serving on the Python Steering Council and he is the release manager for Python 3.10 and 3.11. He has also a cat but he does not code.",
